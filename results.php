...
if (($_GET['a'] >= 2) && ($_GET['b'] < 2) && ($_GET['c'] < 2) && ($_GET['d'] < 2)){
  ?><meta http-equiv="Refresh" content="0;url=a1.php"><?php
}
elseif (($_GET['a'] < 2) && ($_GET['b'] >= 2) && ($_GET['c'] < 2) && ($_GET['d'] < 2)){
...
elseif (($_GET['a'] == 1) && ($_GET['b'] == 1)&& ($_GET['c'] == 1)&& ($_GET['d'] == 1)){
  ?><meta http-equiv="Refresh" content="0;url=q5.php?<?php echo 'a='.$a.'&b='.$b.'&c='.$c.'&d='.$d; ?>"> <?php
}
